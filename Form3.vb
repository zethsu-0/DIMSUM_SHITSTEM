    ...
    Private Sub Button5_Click_1(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Try
            ...
            Else
                ...
                Dim insertQuery As String = "INSERT INTO STOCKS (Item_No, Product_name,product_group, Quatity, Price,taxed_price, Barcode) 
                                     VALUES (@Item_no, @Product_name,@product_group, @Quatity, @Price,@taxed_price, @Barcode)"
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        If MessageBox.Show("Are you sure you want to update this product?", "Confirm Update", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            ...
            Else
                ...
                Dim query As String = "UPDATE stocks SET Item_no=@Item_no,Product_name=@Product_name,product_group=@product_group,Quatity=@Quatity,Price=@Price, taxed_price=@taxed_price, barcode = @barcode WHERE Item_no = @Item_no"
                Using cmd As New SqlCommand(query, con)
                    cmd.Parameters.AddWithValue("@Item_no", Item_no)
                ...
                Using da As New SqlDataAdapter(cmd)
                    Using dt As New DataTable()
                        ...
                        If dt.Rows.Count > 0 Then
                            ...
                            TextBox6.Text = dt.Rows(0)("Quatity").ToString()
